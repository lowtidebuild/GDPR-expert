...
> [!IMPORTANT]
> **As of 2026-05-08, this repo has been superseded by [`data-protection-agent`](https://github.com/lowtidebuild/data-protection-agent) — please use that going forward.**
>
...
|-------|-------------|-------|
| **[data-protection-agent](https://github.com/lowtidebuild/data-protection-agent)** | **Unified Privacy Specialist** *(supersedes this repo)* | **EU GDPR · Korea PIPA · California CCPA** |
